...
;hljs.registerLanguage("php-template",n)})();/*! `makefile` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("java",e)})();/*! `python-repl` grammar compiled for Highlight.js 11.7.0 */
