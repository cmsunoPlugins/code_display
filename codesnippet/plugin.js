				...
				var hljsHighlighter = new CKEDITOR.plugins.codesnippet.highlighter( {
					...
					init: function( callback ) {
						...
						if ( editor.plugins.codesnippet.isSupportedEnvironment() ) {
							CKEDITOR.scriptLoader.load( path + '../highlight/highlight.min.js', function() { // CMSUno
						...
						if ( editor.addContentsCss ) {
							editor.addContentsCss( path + '../highlight/styles/' + editor.config.codeSnippet_theme + '.css' );
						}
					},
 ...
 * @member CKEDITOR.config
 */
CKEDITOR.config.codeSnippet_theme = 'default.min'; // 'brown-paper.min','base16/mocha.min','base16/humanoid-light.min','base16/dirtysea.min','base16/cupertino.min','atom-one-light.min','agate.min';
